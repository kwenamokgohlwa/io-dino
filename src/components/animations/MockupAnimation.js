...
const Wrapper = styled.div`
  ...
  * {
  ...
  background: url("/images/animations/mockup1.svg"), radial-gradient(218.51% 281.09% at 100% 100%, rgba(73, 30, 184, 0.6) 0%, rgba(51, 0, 102, 0.6) 45.83%, rgba(36, 11, 119, 0.6) 100%);
  ...
  .mockup2 {
    ...
    background: url("/images/animations/mockup2.svg"), linear-gradient(198.85deg, #491EB8 12.72%, #330066 54.49%, #280049 100.01%);
  ...
  .dino-logo {
    ...
    background: url("/images/animations/dino-logo.svg"), rgba(255, 255, 255, 0);
  }
`
